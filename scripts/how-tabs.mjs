...
const steps = [
  {
    ...
    solution: "Add ScholarScope from the Chrome Web Store, then pin it.",
    outputJson: `{
                                    <br />
    ...
    codeLines: [
      codeLine("1", `<span class="sky-blue">open</span> Chrome Web Store`),
      codeLine("2", `<span class="sky-blue">click</span> Add to Chrome`),
      codeLine("3", `<span class="lavender">Add to Chrome</span> → pin toolbar`),
