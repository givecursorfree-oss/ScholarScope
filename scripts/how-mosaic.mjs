/** How-it-works mosaic — seamless with site black (neutral-02 / #0b0b0b). */
...
export const howMosaicCss = `
      /* How it works — one black plane (matches site neutral-02), mosaic via 1px stroke */
      ...
      /* Dark slots — stay on the black plane; invert dark wordmarks */
      .ss-how-slot{
        display:flex;
        flex-direction:column;
        align-items:center;
